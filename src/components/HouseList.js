...
const HouseList = ({scrollHome}) => {
    ...
    if(loading){
        return <ImSpinner2 className="mx-auto animate-spin text-violet-700 text-4xl my-8 lg:my-20"/>
    }
    ...
    return (  
        <section>
            <div className="max-w-[1440px] mx-auto px-4 py-6 pb-20">
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-14 justify-items-center">
